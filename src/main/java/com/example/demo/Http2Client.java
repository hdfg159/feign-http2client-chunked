...
public class Http2Client implements Client, AsyncClient<Object> {
    ...
    public CompletableFuture<Response> execute(Request request,
        ...
        CompletableFuture<HttpResponse<InputStream>> future =
                clientForRequest.sendAsync(httpRequest, BodyHandlers.ofInputStream());
    ...
    private HttpClient getOrCreateClient(Options options) {
        if (doesClientConfigurationDiffer(options)) {
            ...
            if (requestScoped == null) {
                HttpClient.Builder builder = newClientBuilder(options)
     ...
     * @return integer key
     */
    public int createClientKey(Options options) {
    ...
    private static HttpClient.Builder newClientBuilder(Options options) {
        return HttpClient
                .newBuilder()
